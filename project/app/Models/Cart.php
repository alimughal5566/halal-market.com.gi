...
// **************** ADD TO CART *******************
     ...
     public function add($item, $id, $size,$color, $keys, $values, $shipPrice) {
        $size_cost = 0;
         $storedItem = ['qty' => 0,'size_key' => 0, 'size_qty' =>  $item->size_qty,'size_price' => $item->size_price, 'size' => $item->size, 'color' => $item->color, 'stock' => $item->stock, 'price' => $item->price, 'item' => $item, 'license' => '', 'dp' => '0','keys' => $keys, 'values' => $values, 'shipprice' => $shipPrice];        if($item->type == 'Physical')
        {
            if ($this->items) {
...
// **************** ADD TO CART MULTIPLE *******************
     ...
     public function addnum($item, $id, $qty, $size, $color, $size_qty, $size_price, $size_key, $keys, $values ,$shipPrice) {
        $size_cost = 0;
         $storedItem = ['qty' => 0,'size_key' => 0, 'size_qty' =>  $item->size_qty,'size_price' => $item->size_price, 'size' => $item->size, 'color' => $item->color, 'stock' => $item->stock, 'price' => $item->price, 'item' => $item, 'license' => '', 'dp' => '0','keys' => $keys, 'values' => $values, 'shipprice' => $shipPrice];
...
// **************** ADDING QUANTITY *******************
   ...
   public function adding($item, $id, $size_qty, $size_price, $shipPrice) {
        $storedItem = ['qty' => 0,'size_key' => 0, 'size_qty' =>  $item->size_qty,'size_price' => $item->size_price, 'size' => $item->size, 'color' => $item->color, 'stock' => $item->stock, 'price' => $item->price, 'item' => $item, 'license' => '', 'dp' => '0','keys' => '', 'values' => '', 'shipprice' => $shipPrice];
        if ($this->items) {
...
// **************** REDUCING QUANTITY *******************
    ...
    public function reducing($item, $id, $size_qty, $size_price, $shipPrice) {
        $storedItem = ['qty' => 0,'size_key' => 0, 'size_qty' =>  $item->size_qty,'size_price' => $item->size_price, 'size' => $item->size, 'color' => $item->color, 'stock' => $item->stock, 'price' => $item->price, 'item' => $item, 'license' => '', 'dp' => '0','keys' => '', 'values' => '', 'shipprice' => $shipPrice];
        if ($this->items) {
            if (array_key_exists($id, $this->items)) {
                $storedItem = $this->items[$id];
