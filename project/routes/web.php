...
Route::prefix('admin')->group(function() {
    ...
    Route::get('/affiliate-setting-show', 'Affiliate\AffiliateController@showAffiliateSetting')->name('admin.affiliate_setting');
    Route::post('/affiliate-setting-show', 'Affiliate\AffiliateController@createAffiliateSetting')->name('admin.affiliate_setting');
    //------------ ADMIN AFFILIATE SECTION ------------
  ...
  Route::get('/orders/delete/{id}', 'Admin\OrderController@destroy')->name('admin-ord-delete');
  // DELETE SECTION ENDS
  ...
  Route::group(['middleware'=>'permissions:affilate_registration'],function(){

    Route::get('/products/affiliation/create',      'Admin\AffiliateRegistrationController@create')->name('admin-affiliation-create');
    Route::get('/products/affiliation/edit/{id}',   'Admin\AffiliateRegistrationController@edit')->name('admin-affiliation-edit');
    Route::get('/products/affiliation/datatables',  'Admin\AffiliateRegistrationController@datatables')->name('admin-affiliation-datatables'); //JSON REQUEST
    Route::get('/products/affiliation/index',       'Admin\AffiliateRegistrationController@index')->name('admin-affiliation-index');
    Route::post('/products/affiliation/store',      'Admin\AffiliateRegistrationController@store')->name('admin-affiliation-store');
    Route::post('/products/affiliation/update/{id}','Admin\AffiliateRegistrationController@update')->name('admin-affiliation-update');
    Route::get('/products/affiliation/delete/{id}','Admin\AffiliateRegistrationController@destroy')->name('admin-affiliation-delete');
    Route::get('/products/affiliation/setting',    'Admin\AffiliateRegistrationController@setting')->name('admin-affiliation-settings');
    Route::post('/products/affiliation/setting/update',    'Admin\AffiliateRegistrationController@UpdateSetting')->name('admin-affiliation-setting.update');
...
// Currency Settings
  ...
  Route::get('/staff/track', 'Admin\StaffController@staffTrack')->name('admin-staff-track');
...
Route::group(['middleware'=>'permissions:super'],function(){
  ...
  // ------------ ROLE SECTION ENDS ----------------------
    ...
    // ------------ VIDEOS SECTION ----------------------
    Route::get('/video/datatables', 'Admin\VideoController@datatables')->name('admin-video-datatables');
    Route::get('/videos', 'Admin\VideoController@index')->name('admin-video-index');
    Route::get('/video/create', 'Admin\VideoController@create')->name('admin-video-create');
    Route::post('/video/create', 'Admin\VideoController@store')->name('admin-video-store');
    Route::get('/video/delete/{id}', 'Admin\VideoController@destroy')->name('admin-video-delete');
...
// affiliate Register
    Route::get('/affiliate', 'Affiliate\AffiliateController@showAffiliateRegisterForm')->name('affiliate-show');
    Route::post('/affiliate', 'Affiliate\AffiliateController@register')->name('affiliate-register');
    Route::get('affiliate-withdraw', 'Affiliate\WithdrawController@index')->name('affiliate-withdraw-index');
    Route::get('affiliate-withdraw-create', 'Affiliate\WithdrawController@create')->name('affiliate-withdraw-create');
    Route::post('affiliate-withdraw-create', 'Affiliate\WithdrawController@store')->name('affiliate-withdraw-store');

    Route::get('/affiliate-dashboard', 'Affiliate\AffiliateController@showDashboard')->name('affiliate-show');
    Route::get('/affiliate-setting', 'Affiliate\AffiliateController@showSetting')->name('affiliate-setting');
//    Route::get('/affiliate/verify/{token}', 'Affiliate\RegisterController@token')->name('user-register-token');
// User Register End
});
