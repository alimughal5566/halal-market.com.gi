                    ...
                    <div class="col-lg-12">
                        ...
                        <form id="geniusform" action="{{ route('admin-ps-homeupdate') }}" method="POST"
                            ...
                            <div class="row justify-content-center">
                                ...
                                <div class="col-lg-4 d-flex justify-content-between">
                                    <label class="control-label" for="videos">{{ __('Videos') }} *</label>
                                    <label class="switch">
                                        <input type="checkbox" name="videos" value="1" {{$data->videos==1?"checked":""}}>
                                        <span class="slider round"></span>
                                    </label>
                                </div>
                                <div class="col-lg-2"></div>
                                <div class="col-lg-4 d-flex justify-content-between">
                                    ...
                                    <label class="switch">
                                        <input type="checkbox" name="service" value="1" {{$data->partners==1?"checked":""}}>
                                        <span class="slider round"></span>
                                    </label>
