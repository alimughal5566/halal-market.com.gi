								...
								<ul>
											...
											<div class="my-dropdown-menu profile-dropdown">
												<ul class="profile-links">
													@if(Auth::user()->type == 'affiliate')
														<li>
															<a href="{{ route('affiliate-show') }}"><i class="fas fa-angle-double-right"></i> Dashboard</a>
														</li>
													@endif
													<li>
                        			...
                        			@if($gs->reg_vendor == 1)
										...
										<li>
											...
											<li>
											<a href="javascript:;" data-toggle="modal" data-target="#affiliate-login" class="sell-btn">Affiliate</a>
										</li>
										@endif
									@endif
...
<!-- VENDOR LOGIN MODAL -->
<div class="modal fade" id="affiliate-login" tabindex="-1" role="dialog" aria-labelledby="vendor-login-Title" aria-hidden="true">
	<div class="modal-dialog  modal-dialog-centered" style="transition: .5s;" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal" aria-label="Close">
			...
			<div class="modal-body">
				<nav class="comment-log-reg-tabmenu">
					<div class="nav nav-tabs" id="nav-tab1" role="tablist">
						<a class="nav-item nav-link login active" id="nav-log-tab12" data-toggle="tab" href="#nav-log12" role="tab" aria-controls="nav-log" aria-selected="true">
							Affiliate Login
						</a>
						<a class="nav-item nav-link" id="nav-reg-tab12" data-toggle="tab" href="#nav-reg12" role="tab" aria-controls="nav-reg" aria-selected="false">
							Affiliate Registration
						</a>
					</div>
				</nav>
				<div class="tab-content" id="nav-tabContent">
					<div class="tab-pane fade show active" id="nav-log12" role="tabpanel" aria-labelledby="nav-log-tab">
						<div class="login-area">
							<div class="login-form signin-form">
								@include('includes.admin.form-login')
								<form class="mloginform" action="{{ route('user.login.submit') }}" method="POST">
					...
					<div class="tab-pane fade" id="nav-reg12" role="tabpanel" aria-labelledby="nav-reg-tab">
						<div class="login-area signup-area">
							<div class="login-form signup-form">
								@include('includes.admin.form-login')
								<form class="mregisterform" action="{{route('user-register-submit')}}" method="POST">
									...
									<div class="row">
										...
										<div class="col-lg-6">
											<div class="form-input">
												Flash Deal				<input type="text" class="User Name" name="phone" placeholder="{{ $langg->lang184 }}" required="">
												<i class="icofont-phone"></i>
											</div>
...
<script>
	$('document').ready(function () {
		...
		$('input[name="ref"]').val($.urlParam('ref'));
		if($.urlParam('ref') !== null && $.urlParam('ref') !== undefined){
			$('a[data-target="#vendor-login"]').click();
			$('#nav-reg-tab11').click();
		}
