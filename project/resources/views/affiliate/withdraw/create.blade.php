                ...
                <div class="col-lg-12">
                    <div class="product-description">
                        <div class="body-area">
                            ...
                            <form id="geniusform" class="form-horizontal" action="{{route('affiliate-withdraw-store')}}" method="POST" enctype="multipart/form-data">
...
{{--                                    <label class="control-label col-sm-12" for="name"><b>{{ $langg->lang498 }} : {{ App\Models\Product::vendorConvertPrice(Auth::user()->current_balance) }}</b></label>--}}
                                    <label class="control-label col-sm-12" for="name"><b>{{ $langg->lang498 }} : {{ Auth::user()->current_balance }}$</b></label>
                                </div>
