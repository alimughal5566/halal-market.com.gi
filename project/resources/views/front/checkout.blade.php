		            ...
		            <div class="total-price">
		              ...
		              <p>
						...
						@elseif(Session::has('coupon_total1'))
							...
							@else
 							<span id="total-cost">{{ Session::has('cart') ? App\Models\Product::convertPrice(Session::get('cart')->totalPrice) : '0.00' }}</span>
						@endif
		              </p>
		            </div>
						...
						<div class="packeging-area">
							...
							@foreach($shipping_data as $data)
								...
								<!-- <input type="hidden" class="shipping" name="shipping" value="{{ $shipping_cost }}"> -->
								@endforeach
							<p style="float: right;"><b>{{ $shipping_cost }}</b></p>
							<p >Shipping Price</p>
						</div>
