...
class ProductController extends Controller
{
    ...
    public function createPhysical()
    {
       $shipping   = Shipping::all();
        $cats       = Category::all();
        $sign       = Currency::where('is_default','=',1)->first();
        return view('admin.product.create.physical',compact('cats','sign', 'shipping'));
    }
    ...
    public function createDigital()
    {
        ...
        $cats       = Category::all();
        $sign       = Currency::where('is_default','=',1)->first();
        return view('admin.product.create.digital',compact('cats','sign', 'shipping'));
    }
    ...
    public function createLicense()
    {
        ...
        $cats       = Category::all();
        $sign       = Currency::where('is_default','=',1)->first();
        return view('admin.product.create.license',compact('cats','sign', 'shipping'));
    }
...
//                $input['childcategory_id'] = $request->childcategory_id;
    ...
    public function edit($id)
    {
        ...
        if($data->type == 'Digital')
            return view('admin.product.edit.digital',compact('cats','data','sign', 'shipping'));
        elseif($data->type == 'License')
            return view('admin.product.edit.license',compact('cats','data','sign', 'shipping'));
        else
             return view('admin.product.edit.physical',compact('cats','data','sign', 'shipping'));
    }
