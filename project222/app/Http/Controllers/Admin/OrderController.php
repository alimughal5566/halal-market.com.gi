...
class OrderController extends Controller
{
    ...
    public function destroy($id)
    {
        ...
        try {
            $vendorOrders = VendorOrder::where('order_id', $id)->get(['id']);
            VendorOrder::destroy($vendorOrders->toArray());

            $orderTracks = OrderTrack::where('order_id', $id)->get(['id']);
            OrderTrack::destroy($orderTracks->toArray());

            $notifications = Notification::where('order_id', $id)->get(['id']);
