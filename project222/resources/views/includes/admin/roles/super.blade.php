...
<li>
    <a href="#affiliation" class="accordion-toggle wave-effect" data-toggle="collapse" aria-expanded="false">
        <i class="icofont-cart"></i>{{ __('Affilicate User') }}
    </a>
    <ul class="collapse list-unstyled" id="affiliation" data-parent="#accordion">
        <li>
            <a href="{{ route('admin-affiliation-create') }}"><span>{{ __('Add Affiliate User') }}</span></a>
        </li>
        <li>
            <a href="{{ route('admin-affiliation-index') }}"><span>{{ __('Manage Users') }}</span></a>
        </li>
        <li>
            <a href="{{ route('admin-affiliation-settings') }}"><span>{{ __('Manage Setting') }}</span></a>
        </li>
    </ul>
</li>
...
<li>
    ...
    <ul class="collapse list-unstyled" id="homepage" data-parent="#accordion">
        ...
        <li>
            <a href="{{ route('admin-video-index') }}"><span>{{ __('Videos') }}</span></a>
        </li>
        <li>
