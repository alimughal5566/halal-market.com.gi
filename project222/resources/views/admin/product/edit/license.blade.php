							...
							<div class="body-area">
								...
								<div class="gocover"
									...
									<div class="row">
										<div class="col-lg-12">
											<div class="left-area">
												<h4 class="heading">{{ __('Shipping Method') }}*</h4>
											</div>
										</div>
										<div class="col-lg-12">
											<select id="cat" name="shipping_id" required="">
												<option value="">{{ __('Select Shipping Method') }}</option>
												@foreach($shipping as $ship)
												<option value="{{ $ship->id }}" @if($data->shipping_id == $ship->id ) selected @endif>{{$ship->title}}</option>
												@endforeach
											</select>
										</div>
									</div>
