          ...
          <div class="xzoom-container">
            ...
            <div class="product-price">
              <p class="title">{{ $langg->lang87 }} :</p>
                    ...
                    @endif
					<br>
				@if($productt->shipping != null)
                    <p class="title">Shipping Price :</p>
					<p class="price"><span id="sizeprice">{{ $productt->shipping->price * $curr->value }}</span>
				@endif
                  </div>
                    ...
                    <ul class="siz-list">
                      ...
                      <li class="{{ $is_first ? 'active' : '' }}">
                        <span class="box">{{ $data1 }}
                          ...
                          <input type="hidden" class="size_price" value="{{ $productt->size_price[$key] }}">
                        </span>
                      </li>
                      @php
                      $is_first = false;
