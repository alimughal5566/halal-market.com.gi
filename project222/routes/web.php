...
//------------ ADMIN AFFILIATE PRODUCT SECTION ------------
  ...
  Route::group(['middleware'=>'permissions:affilate_registration'],function(){
    ...
    Route::post('/products/affiliation/delete/{id}','Admin\AffiliateRegistrationController@destroy')->name('admin-affiliation-delete');
    Route::post('/products/affiliation/setting',    'Admin\AffiliateRegistrationController@setting')->name('admin-affiliation-settings');
...
// ************************************ FRONT SECTION **********************************************
  ...
  // testing-email
  //Route::get('/test-email', 'Front\CartController@testEmail')->name('test.email');
